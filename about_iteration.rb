...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # returns the result of using the injected method
    # with the injected item and each item in the array
  end
  ...
  # safer to do this way. will not cause code errors, 
  # in case file doesn't open for some reason or is corrupt

  # ps: using do will auto-close the file once you're done.
  # otherwise you have to file.close once done.
