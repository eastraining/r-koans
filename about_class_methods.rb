...
class AboutClassMethods < Neo::Koan
  ...
  # I think I prefer explicitly calling self, as it's closer to
  # how Javascript does things, which I'm used to.
  # Shovel operator does make a lot of sense for defining more methods though?
